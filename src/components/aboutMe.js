                        ...
                        <div className = "aboutMe__description">
                            <div className ="aboutMe__workPlace">
                                ...
                                <ul className ="aboutMe__workPlace-list">
                                    ...
                                    <li>Sport-Express - (2019 - 11.2020) (Работа с сайтом, создание нового функционала на Vue и React)</li>
                                </ul>
                            </div>
                            <div class="aboutMe__history">
                                ...
                                После окончания университета переехал в Москву, в которой прожил 5 лет. 3.5 года работал в SEO агентстве, но понял, что 
                                ...
                                уделять время для изучения новых технологий или практикой уже изученных. По личным причинам переехал в Санкт-Петербург,
                                соответственно, ищу работу тоже в Санкт-Петербурге.</p>
                            </div>
                        </div>
